...
import me.elliottleow.kabbalah.clickgui.component.components.sub.*;
...
public class Button extends Component {
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.mod.getName(), (parent.getX() + 3) * 2, (parent.getY() + offset + 2) * 2 + 4, this.mod.isToggled() ? 0x999999 : -1);
