    ...
    public void onRender(final RenderWorldLastEvent event) {
        for (Object e : Minecraft.getMinecraft().theWorld.loadedEntityList) {
            if (e instanceof EntityLiving) {
                ...
                if (entity instanceof EntityPlayer && Kabbalah.settingsManager.getSettingByName(this, "Player").getValBoolean())
                    RenderUtils.entityESPBox((Entity) e, (Kabbalah.settingsManager.getSettingByName(this, "Red").getValDouble() / 100), (Kabbalah.settingsManager.getSettingByName(this, "Green").getValDouble() / 100), (Kabbalah.settingsManager.getSettingByName(this, "Blue").getValDouble() / 100));
